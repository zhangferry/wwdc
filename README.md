...
WWDC Session 中文笔记站，覆盖 2020-2026 七届 WWDC，1100+ 篇文章，包含深度总结与 WWDC 2026 首发速览。

![WWDC 中文总结首页](public/screenshot.png)

## 特性

- 1100+ 篇 WWDC Session 中文技术博客（2020-2026）
...
本项目同时维护一个可独立安装的 `wwdc-notes` skill，用于在 Codex 或 Claude 中离线查询 WWDC 2020-2026 Apple 平台开发知识。
